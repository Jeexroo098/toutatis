...
```
toutatis -u username -s instagramsessioni ranjith_gurudev
```

### Find information from an Instagram ID

```
toutatis -i instagramID -s instagramsessionid 38711627625%3A7z9XPBN6d7BH1j%3A13%3AAYgEsfRGv2DJjsALYyyV3054O4ndn-1IsdFBhlMjcA
```
